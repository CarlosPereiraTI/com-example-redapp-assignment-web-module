...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-example-redapp-assignment-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-example-redapp-assignment-web-module/translations');
